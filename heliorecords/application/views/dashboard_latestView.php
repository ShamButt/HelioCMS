      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="<?php echo base_url('login_controller/view_latest'); ?>">Latest News And Events<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Latest News and Events Details</h2>
		  <?php include("Add_Latest.php");?>
            ...
            <table class="table table-striped" >
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td><a href="#" class = "btn btn-primary">Edit  </a><a href="<?php echo base_url('login_controller/delete?id='); echo $album->id; echo "&a=latest_news_and_events"; ?>" class = "btn btn-danger">  Delete</a></td>
                </tr>
                <?php } ?>
