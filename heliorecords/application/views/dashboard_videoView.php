      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="<?php echo base_url('login_controller/view_youtube'); ?>">Youtube Video<span class="sr-only">(current)</span></a></li>
          </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Youtube Video Link</h2>
          ...
          <div class="table-responsive">
            <table class="table table-striped" >
              ...
              <tbody>
                <?php foreach ($videos as $album) {?>
                <tr>
                  <td><?php echo $album->video; ?></td>
                  
                  
				  <td><a href="#" class = "btn btn-primary">Edit  </a><a href="<?php echo base_url('login_controller/delete?id='); echo $album->id; echo "&a=youtube_video"; ?>" class = "btn btn-danger">  Delete</a></td>
                </tr>
                <?php } ?>
